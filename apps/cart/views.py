...
def add_cart(request, variation_id):
    ...
    if current_user.is_authenticated:
        ...
        is_cart_item_exists = CartItem.objects.filter(variation=variation, user=current_user).exists()

        if is_cart_item_exists:
            cart_item = CartItem.objects.get(variation=variation, user=current_user)
